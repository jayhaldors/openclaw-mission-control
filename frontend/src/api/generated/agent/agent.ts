 ...
 */
export type listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse200 = {
  data: TaskTagRef[];
  status: 200;
};
...
export type listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponseSuccess =
  listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse200 & {
    headers: Headers;
  };
export type listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponseError =
  listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse422 & {
    headers: Headers;
  };

export type listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse =
  | listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponseSuccess
...
export const listTaskTagsApiV1AgentBoardsBoardIdTagsGet = async (
  boardId: string,
  options?: RequestInit,
): Promise<listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse> => {
  return customFetch<listTaskTagsApiV1AgentBoardsBoardIdTagsGetResponse>(
    getListTaskTagsApiV1AgentBoardsBoardIdTagsGetUrl(boardId),
    {
      ...options,
      method: "GET",
    },
...
export const getListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryKey = (
  boardId: string,
) => {
  return [`/api/v1/agent/boards/${boardId}/tags`] as const;
};

export const getListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryOptions = <
  TData = Awaited<
    ReturnType<typeof listTaskTagsApiV1AgentBoardsBoardIdTagsGet>
  >,
  TError = HTTPValidationError,
>(
  boardId: string,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof listTaskTagsApiV1AgentBoardsBoardIdTagsGet>>,
        TError,
        TData
      >
    >;
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryKey(boardId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listTaskTagsApiV1AgentBoardsBoardIdTagsGet>>
  > = ({ signal }) =>
    listTaskTagsApiV1AgentBoardsBoardIdTagsGet(boardId, {
      signal,
      ...requestOptions,
    });
...
export type ListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryResult = NonNullable<
  Awaited<ReturnType<typeof listTaskTagsApiV1AgentBoardsBoardIdTagsGet>>
>;
export type ListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryError =
  HTTPValidationError;

export function useListTaskTagsApiV1AgentBoardsBoardIdTagsGet<
  TData = Awaited<
    ReturnType<typeof listTaskTagsApiV1AgentBoardsBoardIdTagsGet>
  >,
  TError = HTTPValidationError,
...
>(
  ...
  const queryOptions =
    getListTaskTagsApiV1AgentBoardsBoardIdTagsGetQueryOptions(boardId, options);
